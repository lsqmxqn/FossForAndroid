package com.mozilla.firefox.foss.core

import com.mozilla.firefox.foss.core.bridge.*
import com.mozilla.firefox.foss.core.model.*
import com.mozilla.firefox.foss.core.util.parseInetSocketAddress
            ...
            Bridge.nativeFetchAndValid(
                object : FetchCallback {
                    ...
                    override fun complete(error: String?) {
                        if (error != null)
                            completeExceptionally(FossException(error))
                        else
                            complete(Unit)
                    }
                },
