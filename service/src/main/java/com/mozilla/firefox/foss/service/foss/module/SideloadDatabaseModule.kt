...
import com.mozilla.firefox.foss.service.sideload.readGeoipDatabaseFrom
import com.mozilla.firefox.foss.service.store.ServiceStore
import com.mozilla.firefox.foss.service.util.packageName
        ...
        while (true) {
            ...
            try {
                ...
                if (pkg.isNotBlank()) {
                    ...
                    Foss.installSideloadGeoip(data)
