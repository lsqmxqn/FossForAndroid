...
package com.mozilla.firefox.foss.service.data.migrations
...
import com.mozilla.firefox.foss.service.util.generateProfileUUID
...
internal suspend fun migrationFromLegacy(context: Context) {
    val file = context.getDatabasePath("foss-config")
    ...
    context.deleteDatabase("foss-config")
...
private suspend fun migrationFromLegacy234(
    ...
    context.filesDir.resolve("foss").listFiles()?.forEach {
