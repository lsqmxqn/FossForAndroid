...
import com.mozilla.firefox.foss.service.data.Imported
import com.mozilla.firefox.foss.service.data.ImportedDao
import com.mozilla.firefox.foss.service.data.Pending
import com.mozilla.firefox.foss.service.data.PendingDao
import com.mozilla.firefox.foss.service.model.Profile
import com.mozilla.firefox.foss.service.remote.IFetchObserver
import com.mozilla.firefox.foss.service.store.ServiceStore
import com.mozilla.firefox.foss.service.util.importedDir
import com.mozilla.firefox.foss.service.util.pendingDir
import com.mozilla.firefox.foss.service.util.processingDir
import com.mozilla.firefox.foss.service.util.sendProfileChanged
    ...
    suspend fun apply(context: Context, uuid: UUID, callback: IFetchObserver? = null) {
        withContext(NonCancellable) {
            processLock.withLock {
                ...
                Foss.fetchAndValid(context.processingDir, snapshot.source, force) {
                    try {
                        cb?.updateStatus(it)
                    } catch (e: Exception) {
                        cb = null
    ...
    suspend fun update(context: Context, uuid: UUID, callback: IFetchObserver?) {
        withContext(NonCancellable) {
            processLock.withLock {
                ...
                Foss.fetchAndValid(context.processingDir, snapshot.source, true) {
                    try {
                        cb?.updateStatus(it)
                    } catch (e: Exception) {
                        cb = null
