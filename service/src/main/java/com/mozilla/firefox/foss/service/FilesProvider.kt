...
import com.mozilla.firefox.foss.common.util.PatternFileName
import com.mozilla.firefox.foss.service.document.*
    ...
    override fun queryRoots(projection: Array<out String>?): Cursor {
        ...
        return MatrixCursor(projection ?: DEFAULT_ROOT_COLUMNS).apply {
            newRow().apply {
                ...
                add(Root.COLUMN_TITLE, context!!.getString(R.string.foss_for_android))
